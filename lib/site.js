export const site = {
  ...
  tagline: "Built with precision. Finished with care.",
  phone: "(604) 779-9360",
  phoneHref: "tel:+16047799360",
  email: "info@genussrenovation.ca",
  address: {
    street: "12101 80 Ave",
    city: "Surrey",
    region: "BC",
  ...
  stats: [
    ...
    { value: "10+", label: "Lower Mainland cities served" },
  ],
};
...
export const services = [
  {
    ...
    short:
      "Hardwood, engineered, LVP, porcelain, large-format and natural stone — set dead flat, laid dead straight, grouted to a line you could draw with a ruler.",
    hero:
      "The floor is the first thing a room tells you. We make sure it says the right thing.",
    intro:
      "Flooring and tile are where a renovation is judged. A cabinet door can be adjusted; a badly set floor has to come out. Genuss began as a flooring and tiling trade and still runs it as its own division — with dedicated installers, laser-levelled substrate prep, and a finishing crew that carries the same standard through baseboard, casing, trim and paint.",
    pattern: "herringbone",
    accent: "brass",
    bullets: [
      "Hardwood, engineered & luxury vinyl plank",
  ...
  },
  {
    ...
    detail: [
      ...
      {
        h: "Weekly reporting",
        p: "A short written update every week: what got done, what's next, what's waiting on a decision from you, and where the schedule and budget actually stand.",
      },
    ],
    faq: [
      {
  ...
  },
  {
    ...
    short:
      "Retail, office, restaurant and multi-unit work — sequenced around your trading hours, your landlord's rules and your opening date.",
    hero:
      "Every day your space is closed costs you money. We build like we know that.",
    intro:
      "Commercial renovation is a different discipline from residential: base-building constraints, landlord work letters, after-hours access, occupied-premises protocols and an inspection path that can stall an opening for weeks. Genuss handles tenant improvements and commercial fit-outs across the Lower Mainland, including restoration subcontracting for larger general contractors.",
    pattern: "grid",
    accent: "teal",
    bullets: [
      ...
      "Restoration subcontracting for GCs",
      "Landlord work-letter & permit compliance",
    ],
    detail: [
      {
      ...
      },
      {
        ...
        p: "Building, electrical, plumbing, fire and health inspections are booked into the schedule from day one, not chased at the end. Occupancy is a deadline, not a hope.",
      },
      {
        h: "Landlord-ready documentation",
        p: "Insurance certificates, WCB clearance letters, work letters, as-builts and close-out packages delivered in the format property managers actually want.",
      },
      {
        h: "A reliable sub for GCs",
        p: "General contractors use us as a flooring, tiling and restoration subtrade because we show up when we said, staffed at the number we said, with our own supervision.",
      },
    ],
    faq: [
      {
      ...
      },
      {
        ...
        a: "We're fully licensed and insured and carry active WorkSafeBC coverage. Certificates and clearance letters are provided before mobilization.",
      },
    ],
  },
  {
...
export const processSteps = [
  {
    n: "01",
    h: "Consultation",
    p: "We walk the space with you, listen to what you actually want, and tell you plainly what's realistic — in scope, in budget and in time.",
  },
  {
    n: "02",
    h: "Scope & fixed quote",
    p: "A written, itemized scope of work and a firm price. You'll know what's included, what isn't, and exactly where any genuine unknowns sit.",
  },
  {
    n: "03",
    h: "Selections & schedule",
    p: "Materials specified and approved, permits filed, trades booked. We lock the decisions before demolition so the schedule holds.",
  },
  {
    n: "04",
    h: "Build",
    p: "One lead on site, protected surfaces, a clean shop every night, and a written update every week. No mystery weeks where nobody shows up.",
  },
  {
    n: "05",
    h: "Handover & warranty",
    p: "A joint walkthrough, a deficiency list closed out before final invoice, care instructions, and a workmanship warranty that we actually answer the phone for.",
  },
];

export const differentiators = [
  {
    h: "Tradespeople, not brokers",
    p: "Genuss started as a flooring and tiling crew. We still self-perform our core trades instead of marking up a stranger's work.",
  },
  {
    h: "The schedule is a promise",
    p: "We'd rather give you a date we can hold than a date you want to hear. Then we hold it.",
  },
  {
    h: "One number to call",
    p: "A single project lead who knows your job, answers the phone, and doesn't make you re-explain it.",
  },
  {
    h: "Licensed, insured, WCB-covered",
    p: "Full liability coverage and active WorkSafeBC clearance on every site. Certificates on request, always.",
  },
  {
    h: "Clean sites, respected homes",
    p: "Dust containment, floor protection, daily cleanup. You live there — we're guests until we're finished.",
  },
  {
    h: "Written, itemized pricing",
    p: "No vague allowances hiding the real cost. You see the line items, so you can make real decisions.",
  },
];
...
export const projects = [
  {
    ...
    scope: "Curbless shower, linear drain, 1200×600 porcelain, heated floor",
    duration: "3 weeks",
    pattern: "hex",
  },
  {
    title: "5,400 sq ft custom residence",
    type: "Custom Home",
  ...
  {
    title: "Clinic tenant improvement",
    type: "Commercial",
    location: "Burnaby, BC",
    scope: "2,100 sq ft fit-out, after-hours phasing, health inspection",
    duration: "9 weeks",
    pattern: "grid",
  },
  {
  ...
  {
    title: "Herringbone white oak throughout",
    type: "Flooring & Tiling",
    location: "Vancouver Westside",
    scope: "2,800 sq ft engineered herringbone, substrate levelling, trim",
    duration: "4 weeks",
    pattern: "herringbone",
  },
  {
...
export const testimonials = [
  {
    quote:
      "The tile work is the part everyone comments on. Grout lines run dead straight from the entry right through to the shower — you can see it from the front door. That level of layout doesn't happen by accident.",
    name: "Homeowner",
    detail: "Full bathroom renovation — Surrey",
  },
  {
    quote:
      "We stayed open the entire build. They worked nights, cleaned up completely every morning, and we never once had to explain the situation to a customer. The opening date never moved.",
    name: "Retail tenant",
    detail: "Tenant improvement — Burnaby",
  },
  {
    quote:
      "After my accident I couldn't use my own bathroom. They coordinated straight with my case manager and OT, and the finished shower looks better than what was there before. It doesn't look like a hospital.",
    name: "WorkSafeBC claimant",
    detail: "Accessibility modification — Lower Mainland",
  },
];
...
export const faqs = [
  {
    ...
    a: "Surrey, Vancouver, Burnaby, Langley, Richmond, Delta, White Rock, Coquitlam, New Westminster and the wider Lower Mainland. For larger custom and commercial projects we travel further — just ask.",
  },
  {
    q: "Are you licensed and insured?",
    a: "Yes. Genuss Renovation Ltd. is fully licensed and insured, carries active WorkSafeBC coverage, and holds an A+ rating with the Better Business Bureau. Certificates and clearance letters are available on request.",
  },
  {
    q: "Do you provide free quotes?",
    a: "Initial consultations and quotes are free. For complex custom and commercial work we may propose a paid pre-construction phase — you'll always know before anything is billable.",
  },
  {
    q: "How do you price work?",
    a: "Written, itemized scopes with firm pricing. Where a genuine unknown exists — what's behind a wall, what the slab is doing — we flag it up front rather than burying it in a vague allowance.",
  },
  {
    q: "Can you help with WorkSafeBC-funded modifications?",
    a: "Yes. We quote to occupational-therapist scopes, coordinate with case managers, and handle the documentation and invoicing process directly. Call with your claim number and we'll take it from there.",
  },
  {
    q: "Do you offer a warranty?",
    a: "Every project carries a workmanship warranty, in writing, on top of the manufacturer warranties on the materials installed. And we answer the phone after handover.",
  },
];
