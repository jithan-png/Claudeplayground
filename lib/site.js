...
/* Strip used by the scrolling photo marquee. */
export const gallery = [
  { src: "/img/7166937.webp", alt: "Tiled bathroom with large-format porcelain", caption: "Wet room — South Surrey" },
  { src: "/img/1571459.webp", alt: "Modern interior with a floating timber staircase", caption: "Custom home — Morgan Creek" },
  { src: "/img/10855211.webp", alt: "Renovated kitchen with stone island", caption: "Kitchen remodel — Surrey" },
  { src: "/img/1170412.webp", alt: "Open-plan commercial office fit-out", caption: "Tenant improvement — Burnaby" },
  { src: "/img/8583529.webp", alt: "Barrier-free shower with a grab bar", caption: "Accessibility — Langley" },
  { src: "/img/4154991.webp", alt: "Octagon-and-dot tile hallway floor", caption: "Tile entry — White Rock" },
  { src: "/img/15743373.webp", alt: "Living room with wide-plank hardwood", caption: "Flooring — Vancouver" },
  { src: "/img/19966810.webp", alt: "Finished basement living space", caption: "Basement suite — Langley" },
  { src: "/img/7227629.webp", alt: "Walk-in shower with frameless glass", caption: "Bathroom — Surrey" },
  { src: "/img/6585770.webp", alt: "High-end interior with timber slat detailing", caption: "Custom millwork — Surrey" },
];
...
/* The two remaining reviews from their site, used on the reviews page. */
export const moreReviews = [
  {
    quote:
      "Genuss Renovation transformed our outdated bathroom into a modern oasis. Their attention to detail and commitment to quality were truly impressive. We highly recommend them!",
...
/**
 * Indicative planning ranges for the Lower Mainland, not quotes.
 * Every figure here should be replaced with Genuss's own numbers before the
 * site goes live — the page says as much to the reader.
 */
export const costGuide = [
  {
    ...
    range: "$18,000 – $45,000",
    typical: "$25,000 – $32,000",
    duration: "2 – 4 weeks",
    image: "/img/7227629.webp",
    alt: "Renovated bathroom with a frameless glass walk-in shower",
    drivers: [
      "Whether the layout moves — relocating a toilet or shower drain means opening the floor",
      "Tile size and material: large-format and natural stone cost more to set than standard porcelain",
      "Waterproofing system, pre-sloped pan and whether a curbless entry is wanted",
      "Vanity, fixtures and glass — the single most variable line on the whole job",
      "Heated floor, niche detailing and whether the ceiling is being touched",
    ],
  },
  {
    slug: "kitchen",
    ...
    typical: "$45,000 – $70,000",
    duration: "6 – 10 weeks",
    image: "/img/10855211.webp",
    alt: "Renovated kitchen with pale cabinetry and a stone island",
    drivers: [
      "Cabinetry: stock, semi-custom or full custom millwork is the biggest swing in the budget",
      "Counter material — laminate to quartz to natural stone spans an enormous range",
      "Whether plumbing, gas or electrical move, and whether a wall comes out",
      "Appliance package and whether panels and integration are required",
      "Flooring continuity with the rest of the floor, and backsplash tile choice",
    ],
  },
  {
    slug: "basement",
    ...
    typical: "$55,000 – $85,000",
    duration: "8 – 14 weeks",
    image: "/img/19966810.webp",
    alt: "Finished basement living space with large windows",
    drivers: [
      "Whether it becomes a legal suite — egress windows, separate entry, fire separation and permits",
      "Adding a bathroom or kitchenette, and how far the services have to run",
      "Ceiling height, existing moisture conditions and whether underpinning is involved",
      "Framing, insulation and sound separation standards",
      "Finish level: rental-grade versus the finish you'd put on a main floor",
    ],
  },
  {
    slug: "flooring",
    name: "Flooring & tiling",
    range: "$6 – $28 per sq ft installed",
    typical: "$10 – $16 per sq ft",
    duration: "3 days – 3 weeks",
    image: "/img/4263067.webp",
    alt: "Installer fitting engineered hardwood plank flooring",
    drivers: [
      "Material: luxury vinyl plank, engineered hardwood, porcelain and natural stone all price differently",
      "Substrate condition — self-levelling and moisture remediation are priced separately for a reason",
      "Removal and disposal of the existing floor, including any asbestos testing on older homes",
      "Pattern complexity: straight-lay versus herringbone, borders or large-format layout",
      "Transitions, baseboard removal and reinstatement, and any heated-floor system",
    ],
  },
  {
    slug: "whole-home",
    name: "Whole-home renovation",
    range: "$180,000 – $600,000+",
    typical: "$250,000 – $400,000",
    duration: "5 – 12 months",
    image: "/img/4756488.webp",
    alt: "Interior stripped back to the studs during a full home renovation",
    drivers: [
      "Square footage and how much of the structure is being reconfigured",
      "Whether mechanical, electrical and plumbing are being replaced wholesale",
      "Permits, engineering and municipal review — timelines vary a lot by city",
      "Whether you stay in the home during the work, which affects phasing and cost",
      "Finish specification, which on a whole-home job is where budgets are won or lost",
    ],
  },
  {
    slug: "accessibility",
    ...
    duration: "2 – 8 weeks",
    image: "/img/8583529.webp",
    alt: "Barrier-free shower with a stainless grab bar",
    drivers: [
      "Scope defined by the occupational therapist, for WorkSafeBC-funded work",
      "Curbless shower conversion — the single most common and most involved item",
      "Widening doorways, which may mean structural work and refinishing",
      "Ramps, lifts or a zero-threshold entry, and the grade you're working with",
      "Whether the work is funded through WorkSafeBC or privately paid",
    ],
  },
];

/** Local landing pages — one per city Genuss actively serves. */
export const areas = [
  {
    slug: "surrey",
    city: "Surrey",
    blurb:
      "Our home base. We're on site in Surrey most days of the week, from Fleetwood and Newton to Morgan Creek and South Surrey.",
    neighbourhoods: [
      "Fleetwood",
      "Newton",
      "Guildford",
    ...
    local:
      "Surrey has one of the most active renovation markets in the province, and one of the busiest permit desks. A large share of our work here is basement suite conversions, bathroom and kitchen remodels in 1980s and 1990s subdivisions, and full flooring replacements. We know which jobs need a permit in Surrey and which don't, and we file the ones that do.",
    image: "/img/1571459.webp",
    alt: "Modern Surrey interior with a floating timber staircase",
    projects: ["Custom residence, Morgan Creek", "Full kitchen remodel", "Whole-home gut & reconfiguration"],
  },
  {
    slug: "langley",
    city: "Langley",
    blurb:
      "Township and City of Langley — acreage properties, newer subdivisions and character homes all get the same crew and the same standard.",
    neighbourhoods: [
      "Willoughby",
      "Walnut Grove",
      "Murrayville",
    ...
    local:
      "Langley splits between newer Willoughby-era construction and older homes on larger lots. The newer builds usually want finish upgrades — flooring, tile, millwork. The older ones more often need the structure and services addressed before anything cosmetic happens, and we'll tell you which one you have before you commit to a budget.",
    image: "/img/19966810.webp",
    alt: "Finished living space with large windows in a Langley home",
    projects: ["Barrier-free main floor conversion", "Basement suite conversion"],
  },
  {
    slug: "burnaby",
    city: "Burnaby",
    blurb:
      "Residential renovation plus a steady stream of commercial tenant improvements around Metrotown, Brentwood and the Still Creek business parks.",
    neighbourhoods: [
      "Metrotown",
      "Brentwood",
      "Burnaby Heights",
    ...
    local:
      "Burnaby is where a lot of our commercial work sits. Tenant improvements here mean landlord work letters, strata rules, after-hours access and a real inspection path — all of which we schedule from day one rather than chase at the end. On the residential side, high-rise and townhouse renovations bring their own strata approval process, which we handle.",
    image: "/img/1170412.webp",
    alt: "Open-plan Burnaby office fit-out with polished concrete floors",
    projects: ["Open-plan office fit-out", "Large-format porcelain wet room"],
  },
  {
    slug: "vancouver",
    city: "Vancouver",
    blurb:
      "Westside character homes, East Van renovations and condo remodels — with the parking, access and noise-bylaw realities that come with them.",
    neighbourhoods: [
      "Westside",
      "Kitsilano",
      "Dunbar",
    ...
    local:
      "Vancouver renovation is as much a logistics problem as a construction one: street parking, material staging, elevator bookings, noise hours and a permit process that rewards being organized. Older Westside homes frequently need substrate correction before any floor goes down — which is exactly the part most quotes leave out.",
    image: "/img/15743373.webp",
    alt: "Bright Vancouver living room with wide-plank hardwood flooring",
    projects: ["Engineered hardwood throughout"],
  },
  {
    slug: "white-rock",
    city: "White Rock",
    blurb:
      "Coastal properties, downsizer renovations and a lot of aging-in-place work for people who intend to stay in the home they love.",
    neighbourhoods: [
      "East Beach",
      "West Beach",
      "Hillside",
    ...
    local:
      "White Rock has an older demographic than most of the Lower Mainland, and a lot of our work here is accessibility and aging-in-place: curbless showers, grab bars into real blocking, widened doorways and level entries — done to look like a renovation rather than an installation. Coastal exposure also means we pay closer attention to moisture detailing.",
    image: "/img/8583529.webp",
    alt: "Barrier-free shower with a grab bar in a White Rock home",
    projects: ["Patterned tile entry & hall", "Barrier-free main floor conversion"],
  },
  {
    slug: "coquitlam",
    city: "Coquitlam",
    blurb:
      "Tri-Cities renovation — Coquitlam, Port Coquitlam and Port Moody — covering everything from suite conversions to full remodels.",
    neighbourhoods: [
      "Burke Mountain",
      "Westwood Plateau",
      "Maillardville",
    ...
    local:
      "The Tri-Cities mix steep-lot newer construction on Burke Mountain and Westwood Plateau with much older stock closer to Maillardville and Austin Heights. Sloped sites and walk-out basements make suite conversions common here, and they make the drainage and egress details matter more than they would on a flat lot.",
    image: "/img/6585770.webp",
    alt: "High-end Coquitlam interior with timber slat detailing",
    projects: ["Basement suite conversion"],
  },
  {
    slug: "richmond",
    city: "Richmond",
    blurb:
      "Residential and commercial renovation across Richmond, with the flood-plain and high-water-table details the city is known for.",
    neighbourhoods: [
      "Steveston",
      "Broadmoor",
      "Terra Nova",
    ...
    local:
      "Richmond sits on a flood plain, and that shapes renovation more than people expect — slab conditions, moisture testing before any floor goes down, and crawlspace detailing all get more attention here. We moisture-test every Richmond slab before specifying a floor, because the wrong product on a damp slab fails within a year.",
    image: "/img/7166937.webp",
    alt: "Tiled Richmond bathroom with large-format porcelain",
    projects: ["Large-format porcelain wet room"],
  },
  {
    slug: "delta",
    city: "Delta",
    blurb:
      "North Delta, Ladner and Tsawwassen — family-home renovations, suite conversions and flooring across all three communities.",
    neighbourhoods: [
      "North Delta",
      "Ladner",
      "Tsawwassen",
    ...
    local:
      "Delta's three communities are quite different jobs. North Delta is dense family housing where suite conversions and kitchen and bath remodels dominate. Ladner and Tsawwassen bring older character stock and coastal moisture considerations. All three are a short run from our Surrey shop, which keeps scheduling tight.",
    image: "/img/3718434.webp",
    alt: "Bright renovated Delta kitchen",
    projects: ["Full kitchen remodel"],
  },
];
